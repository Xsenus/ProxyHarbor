...
public sealed class PublicOutputCachePolicyTests
{
    ...
    [InlineData("?pageSize=invalid", false)]
    [InlineData("?page=1&pageSize=invalid", false)]
    [InlineData("?pageSize=", false)]
    [InlineData("?pageSize=10.5", false)]
    [InlineData("?pageSize=10,100", false)]
    [InlineData("?pageSize=2147483648", false)]
    [InlineData("?pageSize=-2147483649", false)]
    [InlineData("?pageSize=10&pageSize=20", false)]
    [InlineData("?pageSize=0", true)]
    [InlineData("?pageSize=-1", true)]
    [InlineData("?pageSize=2147483647", true)]
    [InlineData("?pageSize=%2B10", true)]
    [InlineData("?pageSize=%2010%20", true)]
