...
import { Activity, ArrowDownToLine, ArrowRight, Ban, CalendarClock, Check, Clock3, CreditCard, Database, Eye, EyeOff, Gauge, HardDriveDownload, LayoutDashboard, LockKeyhole, LogOut, Mail, Network, Pencil, Play, Plus, Receipt, RefreshCw, Server, Settings2, ShieldCheck, ShieldOff, Trash2, User, Users, Wifi, Workflow, X } from 'lucide-react'
...
type AdminSection = 'overview' | 'operations' | 'sources' | 'backups' | 'users' | 'payments' | 'subscriptions' | 'access'
