...
type TelegramChat = { id:string;chatId:number;telegramUserId:number;userName?:string;firstName?:string;lastName?:string;languageCode?:string;notificationsEnabled:boolean;isBlocked:boolean;createdAt:string;lastInteractionAt:string;subscription:{plan:string;status:string;expiresAt?:string};messages:number }
