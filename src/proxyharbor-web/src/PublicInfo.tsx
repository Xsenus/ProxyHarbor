  ...
  return (
    <article className="public-document">
      ...
      <section>
        ...
        <p>
          Перед использованием каталога посетитель выбирает только необходимые
          технологии либо разрешает статистику. Публичные документы, описание
          услуги и тарифы можно прочитать до выбора; само чтение не включает
          статистику. Сейчас администратором
