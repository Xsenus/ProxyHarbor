...
async function responseMessage(response:Response,fallback:string){try{const problem=await response.json() as {title?:string;detail?:string;message?:string;error?:string};const message=problem.detail||problem.message||problem.title;return [message,problem.error&&problem.error!==message?problem.error:''].filter(Boolean).join(' · ')||fallback}catch{return fallback}}
