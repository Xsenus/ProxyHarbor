...
- Status: `PARTIAL: read-only per-run protection/copy detail, paged destination/route overview, route drain and write-only creation of disabled S3 destinations implemented; activation, pool/route management and provider proof remain`; Codex.
