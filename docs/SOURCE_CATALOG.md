...
Последний полный end-to-end аудит выполнен **10 августа 2026 года в 23:50 (Asia/Novosibirsk)** на отдельной чистой схеме PostgreSQL: **81/81** endpoint от **50/50** провайдеров прошли настоящий collector, ограничения размера, parser и межисточниковую дедупликацию за **4,965 секунды**. Получено 888 116 распознанных строк и **290 217 уникальных кандидатов**; ошибок, пустых результатов, пропущенных/усечённых feed'ов и достижения общего лимита не было. Следующая партия сохранила 1 600/1 600 объективных результатов без `Deferred`, подтвердила 4 Alive и одинаково опубликовала набор в JSON, XML, TXT и CSV; SHA-256 канонического множества — `b5775d509884adee1c78673f76943ce0c6e9ec5750b0302afddc447721d8cc5e`.
