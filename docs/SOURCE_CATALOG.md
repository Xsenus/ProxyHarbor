...
Последний полный production-аудит выполнен **10 августа 2026 года в 19:08 (Asia/Novosibirsk)** на чистой PostgreSQL: **81/81** endpoint от **50/50** провайдеров прошли настоящий collector, ограничения размера, parser и межисточниковую дедупликацию за **5,213 секунды**. Получена 887 861 распознанная строка и **289 830 уникальных кандидатов**; ошибок, пустых результатов, пропущенных/усечённых feed'ов и достижения общего лимита не было. Следующая партия выполнила 1 600 объективных проверок без `Deferred`, подтвердила 6 живых адресов и одинаково опубликовала текущий живой набор в JSON, XML, TXT и CSV.
