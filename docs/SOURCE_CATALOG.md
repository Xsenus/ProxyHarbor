...
Последний полный source-аудит выполнен **10 августа 2026 года в 23:47 (Asia/Novosibirsk)** на отдельной чистой схеме PostgreSQL: **81/81** endpoint от **50/50** провайдеров прошли настоящий collector, ограничения размера, parser и межисточниковую дедупликацию за **5,232 секунды**. Получено 888 134 распознанных строк и **290 039 уникальных кандидатов**; ошибок, пустых результатов, пропущенных/усечённых feed'ов и достижения общего лимита не было. Предшествующий полный validation/export-аудит в 22:47 отдельно выполнил 1 600 объективных проверок без `Deferred`, подтвердил 6 живых адресов и одинаково опубликовал живой набор в JSON, XML, TXT и CSV.
