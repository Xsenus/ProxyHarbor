...
Последний полный production-аудит выполнен **10 августа 2026 года в 11:13 (Asia/Novosibirsk)** на чистой PostgreSQL: **81/81** endpoint от **50/50** провайдеров прошли настоящий collector, ограничения размера, parser и межисточниковую дедупликацию за **6,869 секунды**. Получено 887 656 распознанных строк и **289 245 уникальных кандидатов**; ошибок, пустых результатов, пропущенных/усечённых feed'ов и достижения общего лимита не было. Следующая партия выполнила 250 объективных проверок без `Deferred`, подтвердила 4 живых адреса и одинаково опубликовала их в JSON, XML, TXT и CSV.
