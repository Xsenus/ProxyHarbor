...
- Test/coverage toolchain обновлён до согласованной для modern VSTest связки `Microsoft.NET.Test.Sdk` 18.8.1 и `coverlet.collector` 10.0.1; locked restore, 490 Release-тестов, Cobertura attachment, внутренний coverage-floor и повторный NuGet vulnerability audit проходят без исключений.
